...
<form id="Registro" action="<?php echo $_SERVER['PHP_SELF']; ?>" METHOD="POST">
      <div class="row text-center">
                  <div class="col-sm-12 col-md-12 col-lg-12">
                         <input type="text" name="NombrePlantel" class="form-control" placeholder="Nombre Plantel" required>
                  </div>
      </div>
      ...
      <div class="row text-center">
                  <div class="col-sm-12 col-md-12 col-lg-12">
                         <input type="text" name="ClavePlantel" class="form-control" placeholder="Clave Plantel" required>
                  </div>
      </div>
      ...
      <div class="row text-center">
                  <div class="col-sm-12 col-md-12 col-lg-12">
                         <input type="submit" value="Registrar" name="btn2" class="btn btn-warning">
                  </div>
      </div>
</div>
</div>
